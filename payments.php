					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$tenants =$conn->query("SELECT t.*,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,h.stall_no,h.price FROM tenants t inner join stalls h on h.id = t.house_id where t.status = 1 order by h.stall_no desc ");
