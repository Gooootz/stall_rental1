...
<?php 
$tenants =$conn->query("SELECT t.*,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,h.stall_no,h.price FROM tenants t inner join stalls h on h.id = t.stall_id where t.id = {$_GET['id']} ");
