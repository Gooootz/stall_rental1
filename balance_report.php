						...
						<div class="row">
							<table class="table table-bordered">
								...
								<tbody>
									...
									$i = 1;
									// $tamount = 0;
									$tenants =$conn->query("SELECT t.*,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,h.stall_no,h.price FROM tenants t inner join stalls h on h.id = t.stall_id where t.status = 1 order by h.stall_no desc ");
